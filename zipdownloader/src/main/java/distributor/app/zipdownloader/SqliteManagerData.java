...
public class SqliteManagerData {
    ...
    private static final String TAG_CRLIMIT_PLAFOND = "crlimit";
...
//        String selectQuery = "SELECT  * FROM " + NAMA_TABEL;
    ...
    public ContentValues InsertDataPlafond(String custid, String crlimit, String crlimit2) {
        ...
        values.put(SqliteManagerData.TAG_CRLIMIT, crlimit2);
...
//        String selectQuery = "SELECT  * FROM " + NAMA_TABEL;
    ...
    public ContentValues ambilDataCustomer(String custid, String nama, String alamat, String alamat2, String icjlnid,
