 ...
 */
public class SqliteManagerDetails {
    public static final int VERSI_DATABASE= 1;
    public static final String NAMA_DATABASE = "dbHeaderDetail";
    public static final String NAMA_HEADER = "tbHeader";
    public static final String NAMA_DETAIL = "tbDetail";
...
*/
    ...
    public static final String[] FIELD_TABEL = {SqliteManagerDetails.FIELD_ID,
            SqliteManagerDetails.FIELD_FAKTUR_PENJUALAN,
            SqliteManagerDetails.FIELD_CUSTOMER_ID,
            SqliteManagerDetails.FIELD_KODE_TRANS,
            SqliteManagerDetails.FIELD_TGL,
            SqliteManagerDetails.FIELD_TANGGAL_JAM,
            SqliteManagerDetails.FIELD_KODE_SALES,
            SqliteManagerDetails.FIELD_REFF,
            SqliteManagerDetails.FIELD_GRSS,
            SqliteManagerDetails.FIELD_PPN,
            SqliteManagerDetails.FIELD_D1,
            SqliteManagerDetails.FIELD_D2,
            SqliteManagerDetails.FIELD_D3,
            SqliteManagerDetails.FIELD_NETT,
            SqliteManagerDetails.FIELD_LAT,
            SqliteManagerDetails.FIELD_LONG,
            SqliteManagerDetails.FIELD_JLHREC,
            SqliteManagerDetails.FIELD_IMEI,
            SqliteManagerDetails.FIELD_ORDERNO,
            SqliteManagerDetails.FIELD_KET,
            SqliteManagerDetails.FIELD_GROUP,
            SqliteManagerDetails.FIELD_TOP,
            SqliteManagerDetails.FIELD_TO_CANVAS_DS
...
;    public static final String FIELD_NO_FAKTUR = "no_faktur";
    ...
    public static final String[] FIELD_TABEL_DETAIL = {SqliteManagerDetails.FIELD_ID,
            SqliteManagerDetails.FIELD_NO_URUT,
            SqliteManagerDetails.FIELD_NO_FAKTUR,
            SqliteManagerDetails.FIELD_STOCK_ID,
            SqliteManagerDetails.FIELD_STOCK_NAME,
            SqliteManagerDetails.FIELD_STOCK_OUTLET,
            SqliteManagerDetails.FIELD_QTY,
            SqliteManagerDetails.FIELD_HARGA,
            SqliteManagerDetails.FIELD_JLH,
            SqliteManagerDetails.FIELD_D1,
            SqliteManagerDetails.FIELD_D2,
            SqliteManagerDetails.FIELD_D3,
            SqliteManagerDetails.FIELD_TOTAL,
            SqliteManagerDetails.FIELD_QTYB,
            SqliteManagerDetails.FIELD_QTYM,
            SqliteManagerDetails.FIELD_QTYK,
            SqliteManagerDetails.FIELD_RPD1,
            SqliteManagerDetails.FIELD_RPD2,
            SqliteManagerDetails.FIELD_RPD3
            //  SqliteManager.FIELD_TIPE_SALES
    };
    ...
    private static class SqliteManagerHelper extends SQLiteOpenHelper {
        private static final String BUAT_TABEL =
                "create table " + NAMA_HEADER + " (" +
                        SqliteManagerDetails.FIELD_ID + " integer primary key autoincrement, " +
                        SqliteManagerDetails.FIELD_FAKTUR_PENJUALAN + " text not null ," +
        SqliteManagerDetails.FIELD_CUSTOMER_ID + " text not null ," +
        SqliteManagerDetails.FIELD_KODE_TRANS + " text not null ," +
        SqliteManagerDetails.FIELD_TGL + " text not null ," +
        SqliteManagerDetails.FIELD_TANGGAL_JAM + " text not null ," +
        SqliteManagerDetails.FIELD_KODE_SALES + " text not null ," +
        SqliteManagerDetails.FIELD_REFF + " text not null ," +
        SqliteManagerDetails.FIELD_GRSS + " text not null ," +
        SqliteManagerDetails.FIELD_PPN + " text not null ," +
        SqliteManagerDetails.FIELD_D1+ " text not null ," +
        SqliteManagerDetails.FIELD_D2 + " text not null ," +
        SqliteManagerDetails.FIELD_D3 + " text not null ," +
        SqliteManagerDetails.FIELD_NETT+ " text not null ," +
        SqliteManagerDetails.FIELD_LAT+ " text not null ," +
        SqliteManagerDetails.FIELD_LONG+ " text not null ," +
        SqliteManagerDetails.FIELD_JLHREC+ " text not null ," +
        SqliteManagerDetails.FIELD_IMEI+ " text not null ," +
        SqliteManagerDetails.FIELD_ORDERNO+ " text not null ," +
        SqliteManagerDetails.FIELD_KET+ " text not null ," +
        SqliteManagerDetails.FIELD_GROUP+ " text not null ," +
        SqliteManagerDetails.FIELD_TOP+ " text not null ," +
        SqliteManagerDetails.FIELD_TO_CANVAS_DS+ " text not null " +
        ...
        private static final String BUAT_TABEL_DETAIL =
                "create table " + NAMA_DETAIL + " (" +
                        SqliteManagerDetails.FIELD_ID + " integer primary key autoincrement, " +
                        SqliteManagerDetails.FIELD_NO_URUT + " text not null ," +
                        SqliteManagerDetails.FIELD_NO_FAKTUR + " text not null ," +
                        SqliteManagerDetails.FIELD_STOCK_ID + " text not null ," +
                        SqliteManagerDetails.FIELD_STOCK_NAME + " text not null ," +
                        SqliteManagerDetails.FIELD_STOCK_OUTLET + " text not null ," +
                        SqliteManagerDetails.FIELD_QTY + " text not null ," +
                        SqliteManagerDetails.FIELD_HARGA + " text not null ," +
                        SqliteManagerDetails.FIELD_JLH + " text not null ," +
                        SqliteManagerDetails.FIELD_D1 + " text not null ," +
                        SqliteManagerDetails.FIELD_D2+ " text not null ," +
                        SqliteManagerDetails.FIELD_D3 + " text not null ," +
                        SqliteManagerDetails.FIELD_TOTAL+ " text not null ," +
                        SqliteManagerDetails.FIELD_QTYB + " text not null ," +
                        SqliteManagerDetails.FIELD_QTYM + " text not null ," +
                        SqliteManagerDetails.FIELD_QTYK + " text not null ," +
                        SqliteManagerDetails.FIELD_RPD1 + " text not null ," +
                        SqliteManagerDetails.FIELD_RPD2 + " text not null ," +
                        SqliteManagerDetails.FIELD_RPD3 + " text not null " +
                        //   SqliteManager.FIELD_TIPE_SALES + " text not null " +
                        ");";
    ...
    public SqliteManagerDetails(Context context) {
        crudContext = context;
    }
    ...
    public ArrayList<Header> getAllDataProdukListViewArrayList(String fakturpenjualan){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Header customer = new Header(cursor.getString(POSISI_STOCK_ID), cursor.getString(POSISI_STOCK_NAME),
                        cursor.getString(POSISI_STOCK_OUTLET), cursor.getString(POSISI_HARGA),
                        cursor.getString(POSISI_TOTAL), cursor.getString(POSISI_JLH));
    ...
    public ArrayList<Contact> getAllDataKetdanOrder(String fakturpenjualan){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setName(cursor.getString(POSISI_ORDERNO));
