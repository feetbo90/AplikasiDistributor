 ...
 */
public class SqliteManagerTelahTerkirim {
    public static final int VERSI_DATABASE= 1;
    public static final String NAMA_DATABASE = "dbHeaderTelahTerkirim";
...
*/
    ...
    public static final String[] FIELD_TABEL = {SqliteManagerTelahTerkirim.FIELD_ID,
            SqliteManagerTelahTerkirim.FIELD_FAKTUR_PENJUALAN,
            SqliteManagerTelahTerkirim.FIELD_CUSTOMER_ID,
            SqliteManagerTelahTerkirim.FIELD_KODE_TRANS,
            SqliteManagerTelahTerkirim.FIELD_TGL,
            SqliteManagerTelahTerkirim.FIELD_TANGGAL_JAM,
            SqliteManagerTelahTerkirim.FIELD_KODE_SALES,
            SqliteManagerTelahTerkirim.FIELD_REFF,
            SqliteManagerTelahTerkirim.FIELD_GRSS,
            SqliteManagerTelahTerkirim.FIELD_PPN,
            SqliteManagerTelahTerkirim.FIELD_D1,
            SqliteManagerTelahTerkirim.FIELD_D2,
            SqliteManagerTelahTerkirim.FIELD_D3,
            SqliteManagerTelahTerkirim.FIELD_NETT,
            SqliteManagerTelahTerkirim.FIELD_LAT,
            SqliteManagerTelahTerkirim.FIELD_LONG,
            SqliteManagerTelahTerkirim.FIELD_JLHREC,
            SqliteManagerTelahTerkirim.FIELD_IMEI,
            SqliteManagerTelahTerkirim.FIELD_ORDERNO,
            SqliteManagerTelahTerkirim.FIELD_KET,
            SqliteManagerTelahTerkirim.FIELD_GROUP,
            SqliteManagerTelahTerkirim.FIELD_TOP,
            SqliteManagerTelahTerkirim.FIELD_TO_CANVAS_DS
    ...
    public static final String[] FIELD_TABEL_DETAIL = {SqliteManagerTelahTerkirim.FIELD_ID,
            SqliteManagerTelahTerkirim.FIELD_NO_URUT,
            SqliteManagerTelahTerkirim.FIELD_NO_FAKTUR,
            SqliteManagerTelahTerkirim.FIELD_STOCK_ID,
            SqliteManagerTelahTerkirim.FIELD_STOCK_NAME,
            SqliteManagerTelahTerkirim.FIELD_STOCK_OUTLET,
            SqliteManagerTelahTerkirim.FIELD_QTY,
            SqliteManagerTelahTerkirim.FIELD_HARGA,
            SqliteManagerTelahTerkirim.FIELD_JLH,
            SqliteManagerTelahTerkirim.FIELD_D1,
            SqliteManagerTelahTerkirim.FIELD_D2,
            SqliteManagerTelahTerkirim.FIELD_D3,
            SqliteManagerTelahTerkirim.FIELD_TOTAL,
            SqliteManagerTelahTerkirim.FIELD_QTYB,
            SqliteManagerTelahTerkirim.FIELD_QTYM,
            SqliteManagerTelahTerkirim.FIELD_QTYK,
            SqliteManagerTelahTerkirim.FIELD_RPD1,
            SqliteManagerTelahTerkirim.FIELD_RPD2,
            SqliteManagerTelahTerkirim.FIELD_RPD3
            //  SqliteManager.FIELD_TIPE_SALES
    };
    ...
    private static class SqliteManagerHelper extends SQLiteOpenHelper {
        private static final String BUAT_TABEL =
                "create table " + NAMA_HEADER + " (" +
                        SqliteManagerTelahTerkirim.FIELD_ID + " integer primary key autoincrement, " +
                        SqliteManagerTelahTerkirim.FIELD_FAKTUR_PENJUALAN + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_CUSTOMER_ID + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_KODE_TRANS + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_TGL + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_TANGGAL_JAM + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_KODE_SALES + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_REFF + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_GRSS + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_PPN + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_D1+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_D2 + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_D3 + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_NETT+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_LAT+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_LONG+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_JLHREC+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_IMEI+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_ORDERNO+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_KET+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_GROUP+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_TOP+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_TO_CANVAS_DS+ " text not null " +
        ...
        private static final String BUAT_TABEL_DETAIL =
                "create table " + NAMA_DETAIL + " (" +
                        SqliteManagerTelahTerkirim.FIELD_ID + " integer primary key autoincrement, " +
                        SqliteManagerTelahTerkirim.FIELD_NO_URUT + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_NO_FAKTUR + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_STOCK_ID + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_STOCK_NAME + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_STOCK_OUTLET + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_QTY + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_HARGA + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_JLH + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_D1 + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_D2+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_D3 + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_TOTAL+ " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_QTYB + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_QTYM + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_QTYK + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_RPD1 + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_RPD2 + " text not null ," +
                        SqliteManagerTelahTerkirim.FIELD_RPD3 + " text not null " +
                        //   SqliteManager.FIELD_TIPE_SALES + " text not null " +
                        ");";
    ...
    public SqliteManagerTelahTerkirim(Context context) {
        crudContext = context;
    }
    ...
    public ArrayList<Header> getAllDataHeaderArrayList(){
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Header customer = new Header(cursor.getString(POSISI_FAKTUR_PENJUALAN), cursor.getString(POSISI_CUSTOMER_ID) + ","+ alamat , cursor.getString(POSISI_TANGGAL),
                        ""+Math.round(totalbelanja), cursor.getString(POSISI_ORDERNO),
                       cursor.getString(POSISI_NETT));
...
//        String selectQuery = "SELECT  * FROM " + NAMA_TABEL;
        String nilai = "ok";
        String selectQuery = "SELECT  * FROM " + NAMA_DETAIL + " where " +FIELD_NO_FAKTUR + " = '" + fakturpenjualan + "' and " +FIELD_STOCK_ID + "= '" + kodeproduk + "'   ;"
                ;
